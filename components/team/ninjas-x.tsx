            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between">
              <div className="mb-6 md:mb-0">
                ...
                <p className="text-xl max-w-2xl">
                  Our silent but unstoppable tech warriors who make the magic happen behind the scenes.
                </p>
              </div>
              <Button 
              ...
              {expanded && (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-background/60 backdrop-blur-sm p-6 rounded-lg">
                      <h3 className="text-xl font-semibold mb-4">Culture Highlights</h3>
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center mr-3 mt-0.5">
                            <span className="text-primary text-xs font-bold">05</span>
                          </div>
                          <span>Quarterly hackathons</span>
                        </li>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center mr-3 mt-0.5">
                            <span className="text-primary text-xs font-bold">06</span>
                          </div>
                    ...
                    <div className="bg-background/60 backdrop-blur-sm p-6 rounded-lg">
                      <h3 className="text-xl font-semibold mb-4">Tech Stack Mastery</h3>
                      <div className="flex flex-wrap gap-2">
                        {[
                          "React", "Next.js", "Node.js", "Python", "AWS", "Azure", 
                          "Docker", "Kubernetes", "MongoDB", "PostgreSQL", "TypeScript", 
                          "Go", "Flutter", "React Native", "GraphQL", "Swift", "Kotlin",
                          "TensorFlow", "Kafka", "Redis", "ElasticSearch"
                        ].map((tech) => (
                          <span 
                            key={tech} 
                  ...
                  <div className="mt-8 p-6 bg-background/60 backdrop-blur-sm rounded-lg">
                    <h3 className="text-xl font-semibold mb-4">The Ninja Manifesto</h3>
                    <blockquote className="text-lg italic border-l-4 border-primary pl-4">
                      "We work in the shadows to serve the light. Our code is our craft, our solutions our legacy.
                      We build not just for today, but for tomorrow's challenges. Quality is non-negotiable, 
                      and the user experience is paramount. We are The Ninjas X — silent, effective, unstoppable."
                    </blockquote>
                  </div>
                </motion.div>
              )}
